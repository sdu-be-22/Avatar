...
def index(request):
    return render(request, 'store/profileapp/home.html')
...
def profile(request):
    ...
    context = {'form': form}
    return render(request, 'store/profileapp/profile.html', context)
...
def login_user(request):
    ...
    return render(request, 'store/profileapp/login_page.html')
...
def register_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'store/profileapp/register_page.html', context)
